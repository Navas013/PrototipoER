...
namespace CapaVista
{
    public partial class frmmantenimientoBodega : Form
    {
        ...
        public frmmantenimientoBodega()
        {
           ...
           navegador1.idAplicacion = "7002";//en la nueva se usara el nombre
            ...
            navegador1.funLlenarComboControl(cmbEmpleado, "tipobodega", "pkid", "nombre", "estado");
        ...
        public void funActualizarUsuario(string user)
        {
            ...
            navegador1.aplicacion = "Mantenimiento Bodega";
            navegador1.funActualizarPermisos();
            navegador1.idmodulo = "77";
            navegador1.funReportesVista("ruta", "idAplicacion", "Reporte");
        ...
        {
            navegador1.funComboTextboxVista(cmbEmpleado, txtTipoBodega);
        }
        ...
        {
            navegador1.funTextboxComboVista(cmbEmpleado, txtTipoBodega);
        }
        ...
        private void frmDesarrolloDeCarrera_Load(object sender, EventArgs e)
        {
